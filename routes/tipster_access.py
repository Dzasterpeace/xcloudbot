...
tipster_access_bp = Blueprint('tipster_access', __name__)

@tipster_access_bp.route('/tips/access', methods=['GET'])
@token_required
@swag_from({
    'tags': ['Tipster Access'],
    'responses': {
        200: {'description': 'List of users with access to tipster tips'},
...
@tipster_access_bp.route('/tips/access/grant', methods=['POST'])
@token_required
@swag_from({
    'tags': ['Tipster Access'],
    'parameters': [
...
@tipster_access_bp.route('/tips/access/revoke', methods=['POST'])
@token_required
@swag_from({
    'tags': ['Tipster Access'],
    'parameters': [
